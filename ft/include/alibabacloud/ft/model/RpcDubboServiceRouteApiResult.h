...
#ifndef ALIBABACLOUD_FT_MODEL_RPCDUBBOSERVICEROUTEAPIRESULT_H_
#define ALIBABACLOUD_FT_MODEL_RPCDUBBOSERVICEROUTEAPIRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ft
	{
		namespace Model
		{
			class ALIBABACLOUD_FT_EXPORT RpcDubboServiceRouteApiResult : public ServiceResult
			{
			public:
				...
				RpcDubboServiceRouteApiResult();
				explicit RpcDubboServiceRouteApiResult(const std::string &payload);
				~RpcDubboServiceRouteApiResult();
...
#endif // !ALIBABACLOUD_FT_MODEL_RPCDUBBOSERVICEROUTEAPIRESULT_H_