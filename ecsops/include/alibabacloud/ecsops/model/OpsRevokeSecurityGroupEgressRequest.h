...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPEGRESSREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPEGRESSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsRevokeSecurityGroupEgressRequest : public RpcServiceRequest
			{

			public:
				OpsRevokeSecurityGroupEgressRequest();
				~OpsRevokeSecurityGroupEgressRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPEGRESSREQUEST_H_