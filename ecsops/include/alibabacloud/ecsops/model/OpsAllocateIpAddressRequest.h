...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSALLOCATEIPADDRESSREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSALLOCATEIPADDRESSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsAllocateIpAddressRequest : public RpcServiceRequest
			{

			public:
				OpsAllocateIpAddressRequest();
				~OpsAllocateIpAddressRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSALLOCATEIPADDRESSREQUEST_H_