...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSLIVEMIGRATEECSINSTANCEREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSLIVEMIGRATEECSINSTANCEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsLiveMigrateEcsInstanceRequest : public RpcServiceRequest
			{

			public:
				OpsLiveMigrateEcsInstanceRequest();
				~OpsLiveMigrateEcsInstanceRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSLIVEMIGRATEECSINSTANCEREQUEST_H_