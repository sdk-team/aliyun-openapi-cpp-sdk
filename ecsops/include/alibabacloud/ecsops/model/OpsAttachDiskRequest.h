...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSATTACHDISKREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSATTACHDISKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsAttachDiskRequest : public RpcServiceRequest
			{

			public:
				OpsAttachDiskRequest();
				~OpsAttachDiskRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSATTACHDISKREQUEST_H_