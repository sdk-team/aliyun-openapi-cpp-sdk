...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSMOUNTISOREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSMOUNTISOREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsMountIsoRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSMOUNTISOREQUEST_H_