...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsRevokeSecurityGroupRequest : public RpcServiceRequest
			{

			public:
				OpsRevokeSecurityGroupRequest();
				~OpsRevokeSecurityGroupRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSREVOKESECURITYGROUPREQUEST_H_