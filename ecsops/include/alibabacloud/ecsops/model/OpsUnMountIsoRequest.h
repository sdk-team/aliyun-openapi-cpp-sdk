...
#ifndef ALIBABACLOUD_ECSOPS_MODEL_OPSUNMOUNTISOREQUEST_H_
#define ALIBABACLOUD_ECSOPS_MODEL_OPSUNMOUNTISOREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecsops
	{
		namespace Model
		{
			class ALIBABACLOUD_ECSOPS_EXPORT OpsUnMountIsoRequest : public RpcServiceRequest
			{

			public:
				OpsUnMountIsoRequest();
				~OpsUnMountIsoRequest();
...
#endif // !ALIBABACLOUD_ECSOPS_MODEL_OPSUNMOUNTISOREQUEST_H_