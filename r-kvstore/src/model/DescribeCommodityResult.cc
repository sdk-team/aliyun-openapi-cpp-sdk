...
#include <alibabacloud/r-kvstore/model/DescribeCommodityResult.h>
#include <json/json.h>
...
void DescribeCommodityResult::parse(const std::string &payload)
{
	...
	if(!value["Commodity"].isNull())
		commodity_ = value["Commodity"].asString();

}

std::string DescribeCommodityResult::getCommodity()const
{
	return commodity_;
}
