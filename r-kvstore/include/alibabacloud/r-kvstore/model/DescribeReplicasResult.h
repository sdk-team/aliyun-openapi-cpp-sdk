...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICASRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICASRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeReplicasResult : public ServiceResult
			{
			public:
				struct Items
				{
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICASRESULT_H_