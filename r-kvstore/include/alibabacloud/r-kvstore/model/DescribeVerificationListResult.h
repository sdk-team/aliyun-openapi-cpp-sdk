...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeVerificationListResult : public ServiceResult
			{
			public:
				struct ItemsItem
				{
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_