...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEDBINSTANCEIPARRAYLISTRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEDBINSTANCEIPARRAYLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeDBInstanceIPArrayListResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEDBINSTANCEIPARRAYLISTRESULT_H_