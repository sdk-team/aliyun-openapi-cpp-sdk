...
#ifndef ALIBABACLOUD_DRDS_MODEL_VALIDATESHARDTASKREQUEST_H_
#define ALIBABACLOUD_DRDS_MODEL_VALIDATESHARDTASKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT ValidateShardTaskRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_DRDS_MODEL_VALIDATESHARDTASKREQUEST_H_