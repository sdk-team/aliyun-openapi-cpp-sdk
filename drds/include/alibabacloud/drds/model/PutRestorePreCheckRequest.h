...
#ifndef ALIBABACLOUD_DRDS_MODEL_PUTRESTOREPRECHECKREQUEST_H_
#define ALIBABACLOUD_DRDS_MODEL_PUTRESTOREPRECHECKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT PutRestorePreCheckRequest : public RpcServiceRequest
			{

			public:
				PutRestorePreCheckRequest();
				~PutRestorePreCheckRequest();
...
#endif // !ALIBABACLOUD_DRDS_MODEL_PUTRESTOREPRECHECKREQUEST_H_