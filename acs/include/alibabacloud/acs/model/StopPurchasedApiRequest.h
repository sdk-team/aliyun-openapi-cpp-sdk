...
#ifndef ALIBABACLOUD_ACS_MODEL_STOPPURCHASEDAPIREQUEST_H_
#define ALIBABACLOUD_ACS_MODEL_STOPPURCHASEDAPIREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Acs
	{
		namespace Model
		{
			class ALIBABACLOUD_ACS_EXPORT StopPurchasedApiRequest : public RoaServiceRequest
			{

			public:
				StopPurchasedApiRequest();
				~StopPurchasedApiRequest();
...
#endif // !ALIBABACLOUD_ACS_MODEL_STOPPURCHASEDAPIREQUEST_H_