...
#ifndef ALIBABACLOUD_ACS_MODEL_MODIFYAPINAMEREQUEST_H_
#define ALIBABACLOUD_ACS_MODEL_MODIFYAPINAMEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Acs
	{
		namespace Model
		{
			class ALIBABACLOUD_ACS_EXPORT ModifyApiNameRequest : public RoaServiceRequest
			{

			public:
				ModifyApiNameRequest();
				~ModifyApiNameRequest();
...
#endif // !ALIBABACLOUD_ACS_MODEL_MODIFYAPINAMEREQUEST_H_